;; color-theme-echow.el -- a tango-based color theme for Emacs
;; Revision 7
;;
...
(defun color-theme-echow ()
  ...
  (color-theme-install
   '(color-theme-echow
     ...
     (default ((t (nil))))
     (font-lock-comment-face ((t (:foreground "#0e7900")))) ; dark aluminum
     (font-lock-comment-delimiter-face ((t (:foreground "#0e7900")))) ; dark aluminum
     ...
     (font-lock-doc-face ((t (:foreground "#66406a")))) ; plum
     (font-lock-doc-string-face ((t (:foreground "#66406a")))) ; plum
     (font-lock-string-face ((t (:foreground "#88618c")))) ; plum
     (font-lock-keyword-face ((t (:foreground "#729fcf")))) ; light sky blue
     (font-lock-builtin-face ((t (:foreground "#729fcf")))) ; light sky blue
     (font-lock-function-name-face ((t (:foreground "#ffff99")))) ; light yellow
     (font-lock-variable-name-face ((t (:foreground "#ffcc99")))) ; light orange
     (font-lock-preprocessor-face ((t (:foreground "#888a85")))) ; aluminum
     (font-lock-constant-face ((t (:foreground "#ccffcc")))) ; dark chameleon 4e9a06
     (font-lock-type-face ((t (:foreground "#ccffcc")))) ; light grey
